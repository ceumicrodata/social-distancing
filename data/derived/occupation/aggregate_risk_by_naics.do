...
local indexes teamwork customer presence teamwork_interact customer_interact presence_interact
...
collapse (sum) Employment teamwork_share customer_share presence_share ///
	...
	wh_1days_share wh_2weeks_share wh_1month_share, by(industry_code)
