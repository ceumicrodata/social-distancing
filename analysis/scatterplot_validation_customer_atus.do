...
twoway (scatter customer_interact_index can_wh if customer_interact_index>0, msymbol(O)) ///
	(scatter customer_index can_wh if customer_index>0 & customer_interact_index==0, msymbol(Oh)) ///
